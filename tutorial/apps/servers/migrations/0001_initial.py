# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-07-19 02:59
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('idcs', '0001_initial'),
        ('manufacturer', '0002_auto_20180719_0226'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.CharField(help_text='备注', max_length=200, verbose_name='备注')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rmt_card_ip', models.CharField(db_index=True, help_text='远程管理卡IP', max_length=15, verbose_name='远程管理卡IP')),
                ('cabinet_position', models.CharField(help_text='机柜内位置', max_length=20, null=True, verbose_name='机柜内位置')),
                ('uuid', models.CharField(db_index=True, help_text='UUID', max_length=32, unique=True, verbose_name='UUID')),
                ('last_check', models.DateField(auto_now=True, db_index=True, help_text='检测时间', verbose_name='检测时间')),
